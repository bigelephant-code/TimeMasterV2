...
> GitHub Releases 当前提供的正式安装包仍是 `v0.1.3`；以下能力只存在于当前源码开发线，完成发布验证前不属于 0.1.3 安装包。
...
<p align="center">
  <img src="docs/images/expense-categories.png" width="760" alt="0.1.4-dev 记账类别管理界面，使用虚构演示数据">
</p>
<p align="center"><sub>0.1.4-dev 类别管理实机验收图；来自隔离环境，内容均为虚构数据。</sub></p>
...
- 应用没有账号体系、广告、会员、分析或遥测上报。天气是 0.1.3 正式版和当前 0.1.4-dev 源码中唯一有意联网的功能；启用后会向 Open-Meteo 发送城市搜索文本或经过取整的经纬度。0.1.4-dev 的费用类别管理不增加联网目的地或第三方数据共享。
