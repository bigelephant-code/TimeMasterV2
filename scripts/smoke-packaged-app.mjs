...
try {
  ...
  if (captureDir) {
    for (const name of ['calendar.png', 'calendar-compact.png', 'calendar-month-rollovers.png', 'calendar-month-completions.png', 'calendar-rollover-history.png', 'todos.png', 'matrix.png', 'settings.png', 'settings-remote.png', 'expense-overview.png', 'expense-categories.png', 'expense-compact.png', 'expense-audit.png', 'widget-focus-active.png', 'widget-entry.png', 'widget-ledger.png']) {
