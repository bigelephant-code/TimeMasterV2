...
const api = {
  ...
  aiCoach: {
    ...
    getLocalTaskApi: () => electron.ipcRenderer.invoke("localTaskApi:getConfig"),
    setLocalTaskApiEnabled: (enabled) => electron.ipcRenderer.invoke("localTaskApi:setEnabled", enabled),
    copyLocalTaskApiUrl: () => electron.ipcRenderer.invoke("localTaskApi:copyUrl"),
    rotateLocalTaskApiToken: () => electron.ipcRenderer.invoke("localTaskApi:rotateToken"),
